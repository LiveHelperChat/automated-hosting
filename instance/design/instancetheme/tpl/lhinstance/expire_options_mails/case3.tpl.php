...
<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('instance/email','We are informing that your instance has expired');?>:<?php echo "\n";?>

<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('instance/email','Your instance has expired');?>:
