CREATE TABLE IF NOT EXISTS `lhc_instance_client` (
  ...
  `feature_4_supported` int(11) NOT NULL,
  `feature_5_supported` int(11) NOT NULL,
  `feature_6_supported` int(11) NOT NULL,
  ...
  `custom_fields_4` text NOT NULL,
  `custom_fields_5` text NOT NULL,
  `custom_fields_6` text NOT NULL,
  ...
  `attr_int_4` int(11) NOT NULL DEFAULT '0',
  `attr_int_5` int(11) NOT NULL DEFAULT '0',
  `attr_int_6` int(11) NOT NULL DEFAULT '0',
