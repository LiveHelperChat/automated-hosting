...
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
	...
	<div class="row">	
		<div class="columns large-6">
			...
			<tr>
				<td>
					<input type="hidden" name="on0" value="Request quantity, (1 month extend)"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('instance/edit','Request quantity, (includes 1 month extend)')?></td></tr><tr><td><select name="os0">
